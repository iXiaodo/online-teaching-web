        ...
        try:
            ...
            if verify_res:
                ...
                if email and password:
                    ...
                    doc = yield student_coll.find_one({"_id": email})
                    if not doc:
            ...
            print e
            logging.exception(e)
            self.render("front/front_signin.html", msg=e)
#----------------------------------------------------------注册
class FrontRegistHandler(BaseHandler):
    ...
    def post(self):
        ...
        try:
            ...
            print e
            # self.write_response({},0,_err=str(e))
